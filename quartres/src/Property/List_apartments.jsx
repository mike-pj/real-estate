    ...
    return (
        <section className="bg-[white] py-[110px]  px-[50px]">
            <div className="flex items-center">
                ...
                <form action="" className="w-full relative ml-[34px] z-10 mb-7">
                ...
                <div className="">
                    ...
                    <div className="w-full xl:w-[70%] flex flex-wrap items-center md:items-stretch justify-between mb-[90px] gap-y-5">
                        ...
                        <div className="relative w-full md:w-[44%] group h-fit bg-white shadow-lg rounded-lg">
                            <Link to="">
                                <div className="relative overflow-hidden">
                                    <img className="h-[42svh] w-full group-hover:scale-105 duration-500" src={house_04} alt="house04" />
                                </div>
                            </Link>
                        ...
                        <div className="relative w-full md:w-[44%] group h-fit bg-white shadow-lg rounded-lg">
                            <Link to="">
                                <div className="relative overflow-hidden">
                                    <img
                                        className="h-[42svh] w-full group-hover:scale-105 duration-500"
                                        src={highrise_02}
                                        alt="highrise02"
                                    />
                                </div>
                        ...
                        <div className="relative lg:w-[44%] group h-fit bg-white shadow-lg rounded-lg">
                            <Link to="">
                                <div className="relative overflow-hidden">
                                    <img className="h-[42svh] w-full group-hover:scale-105 duration-500" src={house_05} alt="house05" />
                                </div>
                            </Link>
