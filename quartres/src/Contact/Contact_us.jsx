                        ...
                        <div>
                            <div className="relative mb-5">
                                <textarea
                                    ...
                                    className="w-[90%] mx-auto lg:w-[1037px] lg:h-[20svh]  block border-2 border-gray-300 px-3 py-3"
                                />
                                <i className="absolute top-1/2 -translate-y-5 lg:-translate-y-[63px] right-0 mx-8 text-red-500">
                                    <FaPencil />
                                </i>
                            </div>
                        </div>
