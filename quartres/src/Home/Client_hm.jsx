...
function Client_hm() {
    return (
        <section className='bg-[#f8f8fc] pt-[110px] px-2 lg:px-[50px]'>
            <div className='w-full flex justify-center items-center'>
                <div>
                    <h6 className='border rounded-[50px] w-fit mx-auto px-5 bg-orange-100 mb-8 text-[red]'> Our Testimonial</h6>
                    <h1 className='text-2xl lg:text-[50px] font-bold mb-9'> Clients Feedback</h1>
                </div>
            </div>

            <div className='flex flex-wrap justify-center gap-7 text-base lg:text-lg'>
                <div className='w-full md:w-[42%] xl:w-[30%] border-2 h-[400px] bg-white shadow-lg rounded-lg px-5 pt-[40px]'>
                    ...
                    <p className='leading-9 text-[#6c808a] mb-7'> consectetur adipisicing elitMollitia quam incidunt repudiandae commodi cum officiis dolorum vel numquam eligendi maxime. Perspiciatis nemo aspernatur commodi cum officiis</p>
                ...
                <div className='w-full md:w-[42%] xl:w-[30%] border-2 h-[400px] bg-white shadow-lg rounded-lg px-9 pt-[40px]'>
                    <div className='flex items-center gap-1 text-lg text-[#6c808a] mb-2'>
                        <i className='mt-3'><FaQuoteLeft /></i>
                        <p className='mb-[-15px]'>Lorem ipsum dolor sit, amet</p>
                    </div>
                    <p className='leading-9 text-[#6c808a] mb-7'> consectetur adipisicing elitMollitia quam incidunt repudiandae commodi cum officiis </p>
